...
L.Control.Search = L.Control.extend({
  ...
  onAdd: function( map ) {
    ...
    link.style.backgroundSize = '40px 40px';
    ...
    form.style.right = '42px';
    form.style.top = '12px';
    form.style.zIndex = -10;
    var input = this._input = document.createElement('input');
    input.style.height = '27px';
    input.style.border = '1px solid rgba(74, 74, 74, .5)';
    input.style.borderRadius = '6px';
    input.style.fontFamily = '"HelveticaNeue", "Arial", sans-serif';
